...
var ctx = canvas.getContext('2d') //the quotations single/double don't count
...
var squares = []
//CTRL K + CTRL C WILL COMMENT + CNTRL K +CNTRL U WILL UNDO DO DOMMENT
